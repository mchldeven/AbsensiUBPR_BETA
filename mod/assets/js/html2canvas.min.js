...
!(function (A, e) {
    ...
    var e = (function (A, n) {
        ...
        return (
          A.forEach(function (A, e) {
            ...
            if (4 !== t && 11 !== t)
              return s.push(e), 31 === t ? B.push('strict' === n ? L : X) : t === W ? B.push(_) : 29 === t ? B.push(_) : 43 === t ? ((131072 <= A && A <= 196605) || (196608 <= A && A <= 262141) ? B.push(X) : B.push(_)) : void B.push(t);
  ...
  function RB(A, e, t, r, n, B) {
    ...
    for (var i = 0; 0 < s && i <= 4; i++) {
      ...
      0 == a && $r(B, 1) && '' !== o
        ? (o = e[a] + o)
        : 1 < a || (1 == a && 0 === i) || (1 == a && 1 === i && $r(B, 2)) || (1 == a && 1 === i && $r(B, 4) && 100 < A) || (1 == a && 1 < i && $r(B, 8))
        ? (o = e[a] + (0 < i ? t[i - 1] : '') + o)
        : 1 == a && 0 < i && (o = t[i - 1] + o),
        (s = Math.floor(s / 10));
    }
  ...
  var LB,
    OB,
    vB = { integers: [1e3, 900, 500, 400, 100, 90, 50, 40, 10, 9, 5, 4, 1], values: ['M', 'CM', 'D', 'CD', 'C', 'XC', 'L', 'XL', 'X', 'IX', 'V', 'IV', 'I'] },
    DB = {
                    ...
                    return (
                      ...
                      s &&
                        ...
                        !/(iPad|iPhone|iPod)/g.test(navigator.userAgent) ||
                          ...
                          ((o.documentElement.style.top = -t.top + 'px'), (o.documentElement.style.left = -t.left + 'px'), (o.documentElement.style.position = 'absolute'))),
      ...
      (xB.prototype.cloneNode = function (A) {
        ...
        if (e && QB(A) && (wB(A) || uB(A))) {
          ...
          for (var s = this.counters.parse(new wn(r)), o = this.resolvePseudoContent(A, t, n, LB.BEFORE), i = A.firstChild; i; i = i.nextSibling)
            (QB(i) && ('SCRIPT' === i.tagName || i.hasAttribute(_B) || ('function' == typeof this.options.ignoreElements && this.options.ignoreElements(i)))) ||
    ...
    cs = function (A) {
      ...
      (this.topLeftBorderBox = 0 < n || 0 < B ? us(t.left, t.top, n, B, is.TOP_LEFT) : new ts(t.left, t.top)),
        ...
        (this.bottomRightContentBox =
          0 < c || 0 < Q ? us(t.left + Math.min(F, t.width - (p + T)), t.top + Math.min(E, t.height + H + N), Math.max(0, c - (d + K)), Q - (f + I), is.BOTTOM_RIGHT) : new ts(t.left + t.width - (d + K), t.top + t.height - (f + I))),
  ...
  var Ns = function (c, Q, w, u) {
    ...
    Is = function (A, e, t, r) {
      var n = [];
      return os(A) ? n.push(A.subdivide(0.5, !1)) : n.push(A), os(t) ? n.push(t.subdivide(0.5, !0)) : n.push(t), os(r) ? n.push(r.subdivide(0.5, !0).reverse()) : n.push(r), os(e) ? n.push(e.subdivide(0.5, !1).reverse()) : n.push(e), n;
    },
    Ts = function (A, e, t) {
      var r = e[0],
        n = e[1],
      ...
      var U = null,
        l = null;
      if ((qA(s) ? (U = ae(s, t.width)) : o && qA(o) && (l = ae(o, t.height)), null === U || (o && !fs(o)) || (l = a && c ? (U / r) * n : t.height), null !== l && fs(s) && (U = a && c ? (l / n) * r : t.width), null !== U && null !== l))
        return [U, l];
              ...
              if (
                (e instanceof Jn &&
                  ...
                  e.type === xn
                    ...
                    : e.type === Vn &&
                      e.checked &&
                      (this.ctx.save(), this.ctx.beginPath(), this.ctx.arc(e.bounds.left + i / 2, e.bounds.top + i / 2, i / 4, 0, 2 * Math.PI, !0), (this.ctx.fillStyle = te(Xn)), this.ctx.fill(), this.ctx.restore())),
                Ss(e) && e.value.length)
              ) {
                ...
                (e = function (e) {
                  ...
                  return S(this, function (A) {
                    switch (A.label) {
                      ...
                      case 4:
                        return (
                          t && ((n = ds(b, v, [t.width, t.height, t.width / t.height])), (g = n[0]), (f = n[1]), (p = n[2]), (h = n[3]), (H = n[4]), (l = D.ctx.createPattern(D.resizeImage(t, h, H), 'repeat')), D.renderRepeat(g, l, f, p)),
                          [3, 6]
                        );
                      case 5:
                        !(function (A) {
                              ...
                              switch (A.size) {
                                case Bt.CLOSEST_SIDE:
                                  A.shape === rt.CIRCLE
                                    ...
                                    : A.shape === rt.ELLIPSE && ((B = Math.min(Math.abs(e), Math.abs(e - r))), (s = Math.min(Math.abs(t), Math.abs(t - n))));
                                  break;
                                ...
                                case Bt.FARTHEST_SIDE:
                                  A.shape === rt.CIRCLE
                                    ...
                                    : A.shape === rt.ELLIPSE && ((B = Math.max(Math.abs(e), Math.abs(e - r))), (s = Math.max(Math.abs(t), Math.abs(t - n))));
                                  break;
          ...
          switch (A.label) {
            case 0:
              return (
                ...
                t || e.boxShadow.length ? (this.ctx.save(), this.path(n), this.ctx.clip(), ee(e.backgroundColor) || ((this.ctx.fillStyle = te(e.backgroundColor)), this.ctx.fill()), [4, this.renderBackgroundImage(c.container)]) : [3, 2]
              );
            case 1:
              A.sent(),
                this.ctx.restore(),
            ...
            case 0:
              return (
                this.options.backgroundColor &&
                  ((this.ctx.fillStyle = te(this.options.backgroundColor)), this.ctx.fillRect(this.options.x - this.options.scrollX, this.options.y - this.options.scrollY, this.options.width, this.options.height)),
                (e = (function (A) {
                  var e = new Es(A, []),
                    t = new gs(e),
                    r = [];
          ...
          return S(this, function (A) {
            switch (A.label) {
              ...
              case 1:
                return (
                  (t = A.sent()),
                  this.options.backgroundColor && ((this.ctx.fillStyle = te(this.options.backgroundColor)), this.ctx.fillRect(0, 0, this.options.width * this.options.scale, this.options.height * this.options.scale)),
        ...
        switch (A.label) {
          case 0:
            ...
            return (
              ...
              (u = new PB(p, { id: r, onclone: Q.onclone, ignoreElements: Q.ignoreElements, inlineImages: Q.foreignObjectRendering, copyStyles: Q.foreignObjectRendering })),
