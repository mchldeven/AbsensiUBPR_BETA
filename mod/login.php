...
$kode_karyawan = $huruf . sprintf("%03s", $urutan);
 ...
 <!-- App Capsule -->
    <div id="appCapsule">
        <div style="background:#FFF;border-radius:30px;margin:0 16px;padding:10px 15px" class="section text-center">
            <h1 style="color:#1F1F21;font-size:24px;"><i class="fa fa-user"></i> Login</h1>
            <img src="'.$site_url.'/content/'.$site_logo.'" height="70">
            <h4 style="color:#053F5C;">Masukkan email dan password Anda untuk login ke sistem</h4>
        </div>
