...
<?php echo'
  ...
  <div class="login-box">
    <div class="login-logo">
      <div style="background:#EDD382;border-radius:30px;padding:10px 15px" class="section text-center">
        <h1 style="color:#1A535C;font-size:24px;">Login Administrator</h1>
        <a href="'.$site_url.'"><img src="'.$site_url.'/content/'.$site_logo.'" height="100"></a>
      </div>
    </div>
    <!-- /.login-logo -->
